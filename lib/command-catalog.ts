...
export const commandCatalog: CommandDescriptor[] = [
  ...
  },
  {
    ...
    group: 'access',
    summary:
      'Mint a scoped API token. Session identities only — tokens cannot manage access. The secret is generated by the minting route and shown once.',
    risk: 'write',
    fields: [
      id('id', 'Client-supplied UUID.'),
      text('name'),
      text('scopes', true, "Comma list of catalog groups, plus 'read' and optionally 'destructive'."),
    ],
  },
  {
    name: 'token-revoke',
    group: 'access',
    summary: 'Revoke an API token immediately. Session identities only.',
    risk: 'destructive',
    fields: [id('id')],
  },
  {
